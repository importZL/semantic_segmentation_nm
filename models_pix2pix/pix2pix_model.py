...
class Pix2PixModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        networks.conv_arch = networks.conv_arch.to(self.device)
        networks.upconv_arch = networks.upconv_arch.to(self.device)
    ...
    def set_input(self, train_data, train_target):
        ...
        """
        self.real_mask = train_target.type(torch.cuda.FloatTensor).to(self.device)
        self.real_image = train_data.type(torch.cuda.FloatTensor).to(self.device)
    ...
    def optimize_architect(self, valid_data, valid_target):
        real_mask = valid_target.type(torch.cuda.FloatTensor).to(self.device)
        real_image = valid_data.type(torch.cuda.FloatTensor).to(self.device)
