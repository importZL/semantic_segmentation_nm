    ...
    def run_training(self):
        ...
        # for epoch in range(50):
            ...
            for _ in range(self.num_batches_per_epoch):
                ...
                total_iters += train_data.size()[0]
                epoch_iters += train_data.size()[0]
                self.model.set_input(train_data, train_target)         # unpack data from dataset and apply preprocessing
                self.model.optimize_parameters()   # calculate loss functions, get gradients, update network weights
                self.model.optimize_architect(arch_data, arch_target)
